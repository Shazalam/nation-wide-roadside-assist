    ...
    <section className="py-24 bg-brand-bg relative z-10">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
           {leaders.map((leader, i) => (
             <motion.div
               ...
               viewport={{ once: true }}
             >
                <GlassPanel className="h-full p-6 border-brand-border bg-card/40 hover:bg-[#2F80FF]/10 transition-colors group">
                   <div className="w-16 h-16 rounded-2xl bg-brand-bg border border-brand-border mb-6 flex items-center justify-center overflow-hidden relative">
                   ...
                   <h3 className="text-sm font-black text-foreground dark:text-white leading-tight mb-1">{leader.name}</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
           <GlassPanel className="p-8 border-[#2F80FF]/20 bg-card relative overflow-hidden flex flex-col justify-center">
              <div className="absolute inset-0 bg-[#2F80FF]/5" />
              <h4 className="text-2xl font-black text-foreground dark:text-white mb-4 relative z-10">Operational Command Protocol</h4>
              <p className="text-sm text-brand-slate mb-6 relative z-10 max-w-md leading-relaxed">
           ...
           <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="p-6 bg-white/[0.02] border border-brand-border rounded-2xl flex flex-col items-center justify-center text-center">
                   <p className="text-3xl font-black text-foreground dark:text-white mb-2">{stat.val}</p>
