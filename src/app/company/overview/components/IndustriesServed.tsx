...
import { Truck, Box, Shield, Car, Factory, Building2, Map, Flame } from 'lucide-react';
...
const industries = [
  ...
  { title: 'Emergency Response', icon: Flame, desc: 'Rapid deployment infrastructure for critical hazard zones.' }
];
