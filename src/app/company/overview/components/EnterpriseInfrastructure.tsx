        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
               {[
                 ...
                 <div key={i} className="flex gap-4 group">
                    <div className="h-10 w-10 shrink-0 rounded-xl bg-white/5 flex items-center justify-center border border-white/10 group-hover:bg-[#2F80FF]/10 group-hover:border-[#2F80FF]/30 transition-colors">
                       <item.icon className="h-4 w-4 text-[#94A3B8] group-hover:text-[#2F80FF] transition-colors" />
                    </div>
                    <div>
                       <p className="text-[11px] font-black text-white uppercase tracking-wider mb-1">{item.label}</p>
                       <p className="text-[11px] font-medium text-[#94A3B8] leading-relaxed">{item.desc}</p>
                    </div>
                 </div>
               ))}
            </div>
          ...
          <div className="relative h-[600px] w-full rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
             ...
             <div className="absolute bottom-6 left-6 right-6">
                <GlassPanel className="p-4 bg-[#081120]/80 border-white/10 flex items-center justify-between">
                   <div className="flex gap-6">
                      <div>
                         <p className="text-[8px] font-bold text-[#94A3B8] uppercase tracking-widest mb-1">Active Zones</p>
                         <p className="text-lg font-black text-white leading-none">48 <span className="text-[8px] text-[#2F80FF]">States</span></p>
                      </div>
                      <div>
                         <p className="text-[8px] font-bold text-[#94A3B8] uppercase tracking-widest mb-1">Live Coordination</p>
                         <p className="text-lg font-black text-white leading-none text-emerald-400">1,248 <span className="text-[8px]">Events</span></p>
                      </div>
                   </div>
