              ...
              <GlassPanel className="w-full h-full p-0 border-white/10 bg-[#0A192F]/80 backdrop-blur-2xl shadow-[0_50px_100px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col">
                 ...
                 <div className="px-6 py-4 border-b border-white/5 bg-white/[0.02] flex items-center justify-between shrink-0 relative z-10">
                    <div className="flex items-center gap-3">
                       ...
                       <span className="text-[10px] font-mono font-bold text-white uppercase tracking-widest ml-4">Command Center <span className="text-[#2F80FF] ml-2 font-black">NTI-OS</span></span>
                    </div>
                 </div>

                 {/* Simulated Dispatch UI */}
                 <div className="flex-1 p-6 flex flex-col justify-end relative z-10">
                    <div className="bg-[#081120]/90 border border-white/10 rounded-2xl p-6 backdrop-blur-md shadow-2xl space-y-6 transform translate-y-8 hover:translate-y-4 transition-transform duration-500">
                       <div className="flex justify-between items-center mb-4 border-b border-white/5 pb-4">
                          <div>
                             <p className="text-[10px] font-black text-white uppercase tracking-widest">Active Heavy-Duty Recovery</p>
                             <p className="text-xs text-[#94A3B8] font-bold">Class 8 Commercial Tow</p>
                          </div>
                       ...
                       <div className="space-y-4">
                          <div className="flex items-center justify-between">
                             ...
                             <span className="text-xs font-mono text-[#94A3B8]">Connected</span>
                          </div>
                          ...
                          <div className="grid grid-cols-3 gap-4 pt-4 border-t border-white/5">
                             <div>
                                <p className="text-[9px] font-bold text-[#94A3B8] uppercase tracking-widest">ETA</p>
                                <p className="text-white font-black text-lg">14 Min</p>
                             </div>
                             <div>
                                <p className="text-[9px] font-bold text-[#94A3B8] uppercase tracking-widest">Vendor</p>
                                <p className="text-white font-black text-lg">Unit 84</p>
                             </div>
                             <div>
                                <p className="text-[9px] font-bold text-[#94A3B8] uppercase tracking-widest">SLA Status</p>
