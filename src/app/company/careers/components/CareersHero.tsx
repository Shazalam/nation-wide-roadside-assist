          ...
          <div className="lg:col-span-5 space-y-10">
            ...
            >
              <h1 className="text-5xl lg:text-[4.5rem] font-black leading-[0.95] tracking-tight mb-6 text-white">
                ...
                <span className="text-[#2F80FF]">Infrastructure</span> For <br />
            ...
            >
              {[
                ...
                { label: 'Recovery Events Annually', val: '3.2M+', icon: Database, color: 'text-[#FF7A1A]' },
              ...
              <GlassPanel className="w-full h-full p-0 border-white/10 bg-[#0A192F]/80 backdrop-blur-2xl shadow-[0_50px_100px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col">
                 ...
                 <div className="px-6 py-4 border-b border-white/5 bg-white/[0.02] flex items-center justify-between shrink-0 relative z-10">
                    <div className="flex items-center gap-3">
                       ...
                       <span className="text-[10px] font-mono font-bold text-white uppercase tracking-widest ml-4">Dispatch Operations <span className="text-[#2F80FF] ml-2 font-black">LIVE</span></span>
                    </div>
                 </div>

                 {/* Dashboard Structure */}
                 <div className="flex-1 grid grid-cols-12 gap-px bg-white/5 relative z-10">
                    
                    {/* Left Panel */}
                    <div className="col-span-4 bg-[#081120]/80 p-6 flex flex-col gap-4 overflow-y-auto">
                       <h3 className="text-[10px] font-black text-white uppercase tracking-widest mb-2 border-b border-white/10 pb-2">Active Engineering Deployments</h3>
                       {[1, 2, 3].map(i => (
                         <div key={i} className="p-3 bg-white/5 rounded-lg border border-white/10 relative overflow-hidden group">
                            ...
                            <p className="text-[10px] text-white font-mono">v{i}.8.42_rc</p>
                            <p className="text-[9px] text-[#94A3B8] mt-1">Routing Matrix Optimization</p>
                         </div>
                       ))}
                    ...
                    {/* Main Area */}
                    <div className="col-span-8 bg-[#0A192F]/60 p-6 flex flex-col items-center justify-center relative overflow-hidden">
                       ...
                       <div className="relative w-full max-w-sm">
                          <GlassPanel className="p-6 border-[#2F80FF]/30 bg-[#081120]/90 shadow-[0_0_50px_rgba(47,128,255,0.15)] flex flex-col gap-6">
                             <div className="flex justify-between items-center border-b border-white/5 pb-4">
                                <div>
                                   <p className="text-[10px] font-black text-white uppercase tracking-widest">Incident Orchestration</p>
                                   <p className="text-[9px] text-[#94A3B8] font-bold uppercase mt-1">Multi-Node Coordination</p>
                                </div>
                             ...
                             <div className="h-12 w-full border border-white/10 rounded bg-[#0A192F] relative overflow-hidden flex items-center justify-center">
