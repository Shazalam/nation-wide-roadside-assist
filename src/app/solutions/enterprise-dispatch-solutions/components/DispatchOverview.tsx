...
const highlights = [
  { 
    title: 'North American Dispatch Orchestration', 
    desc: 'Centralized coordination mesh across USA and Canada.', 
    icon: Network,
    image: 'https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?auto=format&fit=crop&q=80'
  },
  { 
    title: 'Multi-Region Incident Coordination', 
    desc: 'Simultaneous management of large-scale operational events.', 
    icon: Share2,
    image: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&q=80'
  },
  { 
    title: 'Intelligent Vendor Matching', 
    desc: 'AI-driven assignment based on proximity and capabilities.', 
    icon: Cpu,
  ...
  { 
    ...
    desc: 'Live ETA calibration and dispatch flow adjustment.', 
    icon: Activity,
    image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc51?auto=format&fit=crop&q=80'
  },
  { 
    title: 'Emergency Roadside Operations', 
    desc: 'Mission-critical response for high-stakes incidents.', 
    icon: Zap,
    image: 'https://images.unsplash.com/photo-1551288049-bbbda536ad0a?auto=format&fit=crop&q=80'
  },
  { 
    title: 'Enterprise Escalation Workflows', 
    desc: 'Automated routing for sensitive or complex cases.', 
    icon: ShieldCheck,
        ...
        <div className="max-w-3xl mx-auto text-center mb-24">
          ...
          >
            <h2 className="text-4xl lg:text-6xl font-black text-foreground dark:text-white tracking-tighter leading-tight mb-8">
               ...
               <span className="text-[#2F80FF]">Infrastructure Orchestration</span>
            </h2>
