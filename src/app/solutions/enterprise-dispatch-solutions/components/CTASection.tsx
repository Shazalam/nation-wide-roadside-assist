      ...
      <div className="container mx-auto px-4">
        <GlassPanel className="p-12 lg:p-24 border-white/10 bg-[#0A192F]/60 relative overflow-hidden text-center max-w-6xl mx-auto shadow-2xl">
           <div className="relative z-10 space-y-8">
              ...
              <h2 className="text-4xl lg:text-7xl font-black text-white leading-[1.1] tracking-tight max-w-4xl mx-auto">
                 Modernize Your Dispatch <br />
                 <span className="text-white/40 italic">Operations Infrastructure</span>
              </h2>
