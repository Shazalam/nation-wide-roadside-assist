...
const steps = [
  { 
    ...
    icon: Zap, 
    description: 'Omnichannel recovery request received via API/Voice/App. Systems instantly capture live GPS coordinates and incident profiles.' 
  },
  { 
    id: 2, 
    title: 'Vehicle Verification', 
    icon: Search, 
    description: 'Automated VIN validation and operational diagnostic check to determine precise equipment requirements.' 
  },
  { 
    id: 3, 
    title: 'Intelligent Assignment', 
    icon: Shield, 
    description: 'AI matches the closest certified vendor with specialized equipment, optimizing for SLA compliance and capacity.' 
  },
  { 
    id: 4, 
    title: 'Dispatch Coordination', 
    icon: Navigation, 
    description: 'Live data exchange and en-route status synchronization. Establishes a direct communication mesh.' 
  },
  { 
    id: 5, 
    title: 'Live Tracking', 
    icon: Globe, 
    description: 'Real-time telemetry and high-precision GPS visibility for all stakeholders throughout the entire recovery process.' 
  },
  { 
    id: 6, 
    title: 'Resolution & Billing', 
    icon: CheckCircle, 
    description: 'Automated reporting, operational review, and zero-touch billing. Syncs directly to enterprise accounting ledgers.' 
  }
];
      ...
      <div className="max-w-[1536px] mx-auto px-6 lg:px-12">
        ...
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-10 lg:mb-12">
           <h2 className="text-4xl lg:text-6xl font-black text-foreground dark:text-white tracking-tighter leading-tight mb-8">
              Mission-Critical <span className="text-[#2F80FF]">Workflow</span>
           </h2>
           <p className="text-brand-slate font-medium text-lg max-w-2xl mx-auto leading-relaxed">
             Standardized operational sequences engineered for high-availability enterprise recovery and dispatch visibility.
           </p>
        </div>
