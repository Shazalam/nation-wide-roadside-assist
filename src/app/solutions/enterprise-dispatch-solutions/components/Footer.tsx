...
const footerLinks = [
  ...
  {
    title: 'Resources',
    links: ['Documentation', 'System Status', 'Help Center', 'Safety Standards', 'Legal Compliance']
  }
];

export const Footer = () => {
  return (
    <footer className="bg-brand-bg pt-24 pb-12 border-t border-white/5 relative z-10">
