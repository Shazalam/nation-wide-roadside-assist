...
export default function MarketIntelligence() {
  return (
    <section className="relative py-24 border-b border-brand-border bg-brand-bg overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row gap-16 items-center mb-16">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-foreground dark:text-white leading-[1.1] tracking-tight mb-6">
          ...
          >
            <GlassPanel className="p-1 rounded-2xl border-brand-border bg-card/40 overflow-hidden relative min-h-[360px] flex flex-col group">
               ...
               <div className="relative z-10 p-8 flex flex-col h-full justify-between flex-1">
                  <div>
                     ...
                     <h3 className="text-2xl font-black text-foreground dark:text-white mb-4 leading-tight">Disrupting the Status Quo<br/>in Auto Insurance</h3>
                  ...
                  <div className="mt-8 flex items-center justify-between border-t border-brand-border pt-6">
                     <div className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-full border border-brand-border bg-white/5 flex items-center justify-center">
                           <Globe className="h-4 w-4 text-[#2F80FF]" />
                        </div>
                        <div>
                           <div className="text-[10px] font-bold text-brand-slate uppercase">Global Reach</div>
                           <div className="text-xs font-mono text-foreground dark:text-white">Trillion Dollar Shift</div>
                        </div>
                     </div>
                  </div>
               </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
           {metrics.map((metric, i) => (
              ...
              >
                 <GlassPanel className="p-6 h-full border-brand-border hover:border-[#2F80FF]/30 transition-all group relative overflow-hidden flex flex-col justify-center">
                    ...
                    <div className="relative z-10 flex flex-col">
                       ...
                       <div className="text-[11px] font-bold text-foreground dark:text-white uppercase tracking-wider mb-1">{metric.label}</div>
                       <div className="text-[10px] font-mono text-brand-slate">{metric.sub}</div>
                    </div>
                 </GlassPanel>
              </motion.div>
           ))}
