         ...
         <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 w-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
               ...
               <div className="lg:col-span-4 space-y-8">
                  <div>
                     <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-500/10 border border-blue-500/20 rounded-full mb-5">
                  ...
                  <div className="bg-[#0A192F]/80 p-6 rounded-2xl border border-white/5 relative overflow-hidden group hidden md:block">
                     ...
                     <div className="relative z-10">
                        ...
                        <div className="flex items-center gap-2">
                           ...
                           <span className="text-[8px] font-mono text-emerald-500 uppercase font-bold tracking-widest">Connection: Secure (AES-256)</span>
                        </div>
                     </div>
                  </div>
               </div>
                              ...
                              {activeTab === 'claims' && (
                                 ...
                                 >
                                    ...
                                    <div className="h-[280px] lg:h-[320px] bg-[#081120] rounded-[2rem] border border-white/5 relative overflow-hidden">
                                       ...
                                       <svg className="w-full h-full p-8 lg:p-14 overflow-visible">
                                          {[
                                             { x: 100, y: 120 }, { x: 300, y: 80 }, { x: 500, y: 200 },
                                             { x: 200, y: 240 }, { x: 600, y: 120 }, { x: 400, y: 280 }
                                          ].map((pt, i) => (
                                             <motion.g key={i}>
                                                <motion.circle
                                                   cx={pt.x} cy={pt.y} r="12" fill="#2F80FF" opacity="0.15"
                                                   animate={{ r: [12, 20, 12] }} transition={{ duration: 4, repeat: Infinity, delay: i * 0.5 }}
                                                />
                                                <circle cx={pt.x} cy={pt.y} r="3" fill="#2F80FF" />
                                                {i % 2 === 0 && (
                                                   <motion.path
                                                      d={`M${pt.x},${pt.y} L${pt.x + 30},${pt.y - 30}`}
                                                      stroke="#2F80FF" strokeWidth="1" strokeDasharray="3 3"
                                    ...
                                    <div className="bg-[#081120] rounded-[2rem] p-6 lg:p-8 border border-white/5 h-[260px] lg:h-[300px] flex flex-col">
                                       ...
                                       <div className="flex-1 flex items-end gap-2 px-2">
                                          {[40, 55, 45, 70, 60, 85, 95, 80, 75, 65, 50, 45].map((h, i) => (
                                             <div key={i} className="flex-1 bg-[#2F80FF]/10 rounded-t relative group">
                                                <motion.div
                                                   initial={{ height: 0 }}
                                                    animate={{ height: `${h}%` }}
                                                   className="absolute bottom-0 left-0 w-full bg-blue-500/30 rounded-t group-hover:bg-blue-500/50 transition-all"
                                                />
                                                <motion.div
                                                   initial={{ height: 0 }}
                                                   animate={{ height: `${h - (i % 3 * 5)}%` }}
                                                   className="absolute bottom-0 left-1/4 w-1/2 bg-orange-500 rounded-t group-hover:bg-orange-400 transition-all"
                                                />
                                             </div>
                                          ))}
                                       </div>
