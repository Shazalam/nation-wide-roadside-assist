...
const steps = [
  {
    ...
    description: 'Member requests assistance via app, web, or phone integration. Systems instantly capture live GPS coordinates, vehicle profiles, and customer policy metadata.',
    icon: UserPlus,
    image: 'https://images.unsplash.com/photo-1549923746-c502d488b3ea?auto=format&fit=crop&q=80&w=600',
    stat: '99.8% Ingest Rate',
    metric: 'API Response < 12ms'
  },
  {
    id: 2,
    title: 'Claims Validation',
    description: 'Policy verification and eligibility confirmation in real-time. Automatically checks coverage limits, active membership status, and deductible rules.',
    icon: ShieldCheck,
    image: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&q=80&w=600',
    stat: '100% Automated Checks',
    metric: 'MFA & JWT Secure'
  },
  {
    id: 3,
    title: 'Intelligent Vendor Routing',
    description: 'AI matches the best vendor based on SLA, location & capacity. Prioritizes certified operators with correct tow classes and equipment capabilities.',
    icon: Search,
    image: 'https://images.unsplash.com/photo-1524661135-423995f22d0b?auto=format&fit=crop&q=80&w=600',
    stat: '98.4% Match Accuracy',
    metric: 'Proximity Dispatch'
  },
  {
    id: 4,
    title: 'Live Dispatch Tracking',
    description: 'Real-time tracking and updates for complete visibility. Streams high-precision GPS coordinates, active map routes, and technician status changes.',
    icon: Radio,
    image: 'https://images.unsplash.com/photo-1527529482837-4698179dc6ce?auto=format&fit=crop&q=80&w=600',
    stat: 'Live GPS Broadcast',
    metric: 'Websocket Enabled'
  },
  {
    id: 5,
    title: 'Roadside Resolution',
    description: 'Vendor arrives, issue resolved, member satisfied. Logs digital signatures, photograph proofs of service, and technical resolution telemetry.',
    icon: Wrench,
    image: 'https://images.unsplash.com/photo-1562240020-ce31ccb0fa7d?auto=format&fit=crop&q=80&w=600',
    stat: '28m Avg Resolution',
    metric: 'Certified Providers'
  },
  {
    id: 6,
    title: 'Automated Billing & Reporting',
    description: 'Claims closed, billing automated, reports generated. Syncs structured invoice payloads directly to enterprise accounting ledgers and ERP systems.',
    icon: FileText,
    image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=600',
    stat: 'Zero-Touch Invoicing',
    metric: 'Instant Financial Sync'
  },
];
