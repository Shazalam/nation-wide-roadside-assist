  ...
  return (
    <div className="min-h-screen bg-brand-bg flex flex-col items-center justify-center p-4">
      ...
      >
        ...
        <h2 className="text-2xl font-black text-foreground dark:text-white uppercase tracking-tight mb-2">Network Disruption</h2>
        ...
        <div className="mt-8 pt-8 border-t border-brand-border flex items-center justify-center gap-2">
           ...
           <span className="text-[10px] font-mono text-brand-slate uppercase">Trans-Ops Support: 1-888-INSURE-TECH</span>
        </div>
      </motion.div>
    </div>
  );
