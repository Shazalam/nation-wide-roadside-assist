    ...
    <section className="py-32 px-6 lg:px-12 relative overflow-hidden flex items-center justify-center min-h-[60vh]">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <button className="w-full sm:w-auto px-8 py-4 bg-[#2F80FF] hover:bg-[#2F80FF]/90 text-white rounded-lg font-medium transition-all shadow-[0_0_20px_rgba(47,128,255,0.3)] hover:shadow-[0_0_30px_rgba(47,128,255,0.5)] flex items-center justify-center gap-2 group">
            Contact Enterprise Team <ChevronRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
          </button>
          <button className="w-full sm:w-auto px-8 py-4 bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] hover:bg-[rgba(255,255,255,0.1)] text-white rounded-lg font-medium transition-all">
