  ...
  return (
    <div className="min-h-screen bg-[#081120] flex flex-col items-center justify-center p-4">
      ...
      >
        ...
        <h2 className="text-2xl font-black text-white uppercase tracking-tight mb-2">Operational Breach</h2>
        ...
        <div className="mt-8 pt-8 border-t border-white/5 flex items-center justify-center gap-2">
           ...
           <span className="text-[10px] font-mono text-[#94A3B8] uppercase">Contact Network Support: 1-800-TRANS-OPS</span>
        </div>
      </motion.div>
    </div>
  );
