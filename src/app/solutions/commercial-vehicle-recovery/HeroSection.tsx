    ...
    <section className="relative min-h-[90vh] lg:min-h-screen pt-20 pb-8 lg:pt-28 lg:pb-12 flex items-center overflow-hidden bg-[#020617]">
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          alt="Enterprise Commercial Recovery Infrastructure"
        ...
        <div className="max-w-4xl space-y-10">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <span className="text-brand-blue">Recovery Infrastructure</span>
            </motion.h1>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 pt-12">
            {[
              { label: 'SLA Compliance',  val: '99.1%',      icon: Shield,   color: 'text-brand-blue'   },
              { label: 'Fleet Assets',    val: '4,892+',     icon: Zap,      color: 'text-brand-orange' },
              { label: 'Network Load',    val: 'Optimized',  icon: Globe,    color: 'text-purple-400'   },
