      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-end gap-8 mb-16">
          ...
          <div className="flex items-center gap-4">
             <div className="bg-white/5 border border-brand-border px-6 py-3 rounded-xl">
                <div className="text-[9px] text-brand-slate uppercase tracking-widest mb-1">Total Support Events</div>
                <div className="text-2xl font-black text-foreground dark:text-white font-mono">3.2M+</div>
             </div>
             <div className="bg-blue-500/10 border border-blue-500/20 px-6 py-3 rounded-xl">
                ...
                <div className="text-2xl font-black text-foreground dark:text-white font-mono">+24.8%</div>
             </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 bg-card/50 backdrop-blur-3xl border border-brand-border rounded-3xl p-8 shadow-2xl">
            <div className="flex justify-between items-center mb-10">
               <div>
                  <h3 className="text-xl font-black text-foreground dark:text-white uppercase tracking-wider">Recovery Lifecycle Performance</h3>
                  <p className="text-[10px] font-mono text-brand-slate mt-1">Cross-Platform Dispatch Efficiency Index</p>
               </div>
               <div className="flex gap-4">
                  <div className="flex items-center gap-2">
                     <div className="w-3 h-3 rounded-full bg-[#2F80FF]" />
                     <span className="text-[10px] text-brand-slate uppercase">Recoveries</span>
                  </div>
                  <div className="flex items-center gap-2">
                     <div className="w-3 h-3 rounded-full bg-[#FF7A1A]" />
                     <span className="text-[10px] text-brand-slate uppercase">Response Time (m)</span>
                  </div>
               </div>
            </div>
          ...
          <div className="lg:col-span-4 space-y-8">
             <div className="bg-card/50 backdrop-blur-3xl border border-brand-border rounded-3xl p-8 shadow-2xl">
                <h3 className="text-sm font-black text-foreground dark:text-white uppercase tracking-widest mb-8">Regional SLA Compliance</h3>
                <div className="space-y-6">
                   {regionalPerformance.map((item, i) => (
                     <div key={i} className="space-y-2">
                        <div className="flex justify-between items-center">
                           <span className="text-xs font-bold text-foreground dark:text-white">{item.region}</span>
             ...
             <div className="bg-gradient-to-br from-[#2F80FF]/20 to-[#FF7A1A]/10 backdrop-blur-3xl border border-brand-border rounded-3xl p-8 relative overflow-hidden">
                <div className="relative z-10">
                   <div className="p-3 rounded-xl bg-blue-500/20 w-fit mb-6">
                      <TrendingUp className="w-6 h-6 text-[#2F80FF]" />
                   </div>
                   <h4 className="text-xl font-black text-foreground dark:text-white mb-2">Predictive Asset Placement</h4>
                   <p className="text-[11px] text-brand-slate leading-relaxed mb-6">
                ...
                <div className="absolute -bottom-6 -right-6 opacity-10">
                   <Globe className="w-32 h-32 text-foreground dark:text-white" />
                </div>
             </div>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16">
           {[
             ...
             <div key={i} className="text-center p-6 border-r border-brand-border last:border-0">
                <div className="flex justify-center mb-4">
                   <m.icon className="w-5 h-5 text-[#2F80FF]" />
                </div>
                <div className="text-2xl font-black text-foreground dark:text-white font-mono">{m.val}</div>
                <div className="text-[9px] text-brand-slate uppercase tracking-[0.2em] mt-2">{m.label}</div>
             </div>
           ))}
        </div>
