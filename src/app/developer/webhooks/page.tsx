  ...
  return (
    <div className="space-y-12">
      <section className="space-y-4">
        <h1 className="text-4xl font-bold text-white tracking-tight">Webhooks</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div className="space-y-1">
                <p className="text-white font-bold">Configure Endpoint</p>
            ...
            <div className="flex gap-4">
              ...
              <div className="space-y-1">
                <p className="text-white font-bold">Receive HTTPS POST</p>
            ...
            <div className="flex gap-4">
              ...
              <div className="space-y-1">
                <p className="text-white font-bold">Acknowledge Receipt</p>
        ...
        <GlassPanel className="p-8 border-white/5 bg-brand-navy/40">
    ...
    "location": {
      ...
      <section className="space-y-8">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-2xl font-bold text-white">Verifying Signatures</h2>
        </div>
  ...
  if (signature === expectedSignature) {
    ...
    res.status(401).send('Invalid signature');
          ...
          <div className="lg:col-span-5 space-y-4">
             <GlassPanel className="p-6 border-white/5 space-y-4 h-full">
                <div className="flex items-center gap-2 text-brand-blue">
                   <AlertCircle className="h-4 w-4" />
                   <span className="text-[10px] font-black uppercase tracking-widest">Crucial Note</span>
                </div>
                <p className="text-sm text-brand-slate leading-relaxed">
                   Signatures are generated using <span className="text-white font-mono">HMAC-SHA256</span>. The secret key is unique to each webhook endpoint you configure and can be found in the developer settings.
                </p>
                <p className="text-sm text-brand-slate leading-relaxed">
                   Always use a <span className="text-white font-mono">raw body</span> for verification to avoid issues with JSON parsing differences.
                </p>
             </GlassPanel>
          </div>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="text-sm text-brand-slate">
              <tr className="border-b border-white/5 hover:bg-white/[0.01]">
                <td className="py-4 px-4 font-mono text-white">dispatch.created</td>
                <td className="py-4 px-4">Occurs when a new dispatch request is successfully initialized.</td>
              </tr>
              <tr className="border-b border-white/5 hover:bg-white/[0.01]">
                <td className="py-4 px-4 font-mono text-white">dispatch.vendor_assigned</td>
                <td className="py-4 px-4">Occurs when a service provider has accepted the request.</td>
              </tr>
              <tr className="border-b border-white/5 hover:bg-white/[0.01]">
                <td className="py-4 px-4 font-mono text-white">dispatch.arrival_confirmed</td>
                <td className="py-4 px-4">Occurs when the vendor confirms arrival at the service location.</td>
              </tr>
              <tr className="border-b border-white/5 hover:bg-white/[0.01]">
                <td className="py-4 px-4 font-mono text-white">telemetry.ping</td>
      ...
      <section className="p-8 rounded-2xl bg-brand-blue/5 border border-brand-blue/10 flex gap-6">
        ...
        <div className="space-y-2">
           <h4 className="font-bold text-white uppercase tracking-wider text-xs">Retry Policy</h4>
           <p className="text-sm text-brand-slate leading-relaxed">
