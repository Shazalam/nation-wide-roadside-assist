    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 min-h-[700px]">
        ...
        <div className="lg:col-span-4 flex flex-col gap-4">
          ...
          <GlassPanel className="flex-1 p-2 overflow-y-auto border-brand-border bg-brand-bg/40">
                       ...
                       {group.items.map((item) => (
                         <button
                           ...
                           className={cn(
                             ...
                             selectedId === item.id 
                               ? "bg-brand-blue/10 text-foreground dark:text-white border border-brand-blue/20" 
          ...
          <Button variant="outline" className="border-brand-border bg-white/5 text-brand-slate text-[10px] font-bold uppercase tracking-widest hover:text-foreground dark:text-white">
        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
           {selectedEndpoint && (
             <>
               <GlassPanel className="p-8 border-brand-border bg-brand-bg/60 space-y-6">
                  <div className="flex items-center justify-between">
                     <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-xl font-mono text-foreground dark:text-white">{selectedEndpoint.path}</h2>
                     </div>
                     <Button className="bg-brand-blue text-foreground dark:text-white text-[10px] font-bold h-8 px-4 uppercase tracking-widest">
                  ...
                  <div className="space-y-4">
                     <h4 className="text-xs font-black text-foreground dark:text-white uppercase tracking-widest">Parameters</h4>
                     <div className="space-y-3">
                        <div className="grid grid-cols-12 gap-4 items-center p-3 rounded-lg bg-white/[0.02] border border-brand-border">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                     ...
                     <GlassPanel className="p-4 bg-black/40 border-brand-border font-mono text-xs overflow-auto h-[300px]">
