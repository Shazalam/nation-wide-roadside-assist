...
export default function FleetTelemetryPage() {
    ...
    <div className="space-y-12">
      <section className="space-y-4">
        <div className="flex items-center gap-3">
           ...
           <h1 className="text-4xl font-bold text-white tracking-tight">Fleet Telemetry</h1>
        </div>
      ...
      <GlassPanel className="p-1 border-white/5 bg-black/40 overflow-hidden">
      ...
      <section className="space-y-6">
        <div className="space-y-2">
           <h3 className="text-xl font-bold text-white">Fetch Asset Diagnostics</h3>
  ...
  -H "Authorization: Bearer <TOKEN>"`}
              ...
              <div className="mt-4">
                 ...
                 <GlassPanel className="p-4 bg-black/40 border-white/5 font-mono text-xs">
...
{`{
  ...
  "status": "in_motion"
           ...
           <div className="lg:col-span-5 space-y-6">
              <GlassPanel className="p-6 border-white/5 bg-brand-navy/40">
              ...
              <div className="grid grid-cols-1 gap-4">
                 <div className="flex items-center gap-3 p-4 rounded-xl border border-white/5 bg-white/5">
                    ...
                    <div>
                       <p className="text-[10px] font-bold text-white uppercase tracking-widest">OBD-II Passthrough</p>
                 ...
                 <div className="flex items-center gap-3 p-4 rounded-xl border border-white/5 bg-white/5">
                    ...
                    <div>
                       <p className="text-[10px] font-bold text-white uppercase tracking-widest">Tamper Detection</p>
