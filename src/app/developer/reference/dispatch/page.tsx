    ...
    <div className="space-y-12">
      <section className="space-y-4">
        <div className="flex items-center gap-3">
           ...
           <h1 className="text-4xl font-bold text-white tracking-tight">Dispatch API</h1>
        </div>
      ...
      <section className="space-y-8">
        <div className="flex items-center justify-between">
           <h2 className="text-2xl font-bold text-white">Lifecycle of a Dispatch</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 relative">
           ...
           <div className="absolute top-1/2 left-0 w-full h-[1px] border-t border-dashed border-white/10 hidden md:block -z-10" />
           ...
           {[
             ...
             <GlassPanel key={item.step} className="p-6 text-center border-white/5 bg-brand-bg/60">
      ...
      <section className="space-y-6">
        <div className="space-y-2">
           <h3 className="text-xl font-bold text-white">Create a New Dispatch</h3>
  ...
  "customer": {
    ...
    "phone": "+1555019922"
           ...
           <div className="lg:col-span-5">
              <GlassPanel className="p-6 border-white/5 bg-brand-navy/40 h-full">
                 ...
                 <div className="space-y-4">
                    <div className="flex justify-between items-start border-b border-white/5 pb-3">
                       <div>
                          <p className="text-xs font-mono text-white">type</p>
                    ...
                    <div className="flex justify-between items-start border-b border-white/5 pb-3">
                       <div>
                          <p className="text-xs font-mono text-white">priority</p>
                    ...
                    <div className="flex justify-between items-start">
                       <div>
                          <p className="text-xs font-mono text-white">metadata</p>
                          <p className="text-[10px] text-brand-slate">Object: Max 20 key-value pairs</p>
                       </div>
                       <span className="text-[8px] font-bold text-brand-slate bg-white/5 px-1 rounded border border-white/10">OPT</span>
                    </div>
                 </div>
              </GlassPanel>
           </div>
      ...
      <section className="p-8 rounded-2xl bg-rose-500/5 border border-rose-500/10 flex gap-6">
        ...
        <div className="space-y-2">
           <h4 className="font-bold text-white uppercase tracking-wider text-xs">High-Priority Dispatch Policy</h4>
