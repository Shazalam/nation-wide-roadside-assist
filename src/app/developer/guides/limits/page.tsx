    ...
    <div className="space-y-12">
      <section className="space-y-4">
        <div className="flex items-center gap-3">
           ...
           <h1 className="text-4xl font-bold text-white tracking-tight">Rate Limiting</h1>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
         <GlassPanel className="p-8 border-white/5 bg-brand-bg/40 space-y-4">
            <h3 className="text-xl font-bold text-white">Standard Limits</h3>
            <div className="space-y-4">
               ...
               <div className="flex justify-between items-center border-b border-white/5 pb-3">
                  ...
                  <span className="text-white font-bold">500 req/min</span>
               </div>
               <div className="flex justify-between items-center border-b border-white/5 pb-3">
                  <span className="text-brand-slate text-sm font-mono">/v1/vendors/*</span>
                  <span className="text-white font-bold">200 req/min</span>
               </div>
               <div className="flex justify-between items-center">
                  <span className="text-brand-slate text-sm font-mono">All other</span>
                  <span className="text-white font-bold">1,000 req/min</span>
               </div>
            </div>
         </GlassPanel>

         <div className="space-y-6">
            <h3 className="text-xl font-bold text-white">Handling Limits</h3>
            ...
            <div className="p-4 rounded-lg bg-black/40 border border-white/5 font-mono text-xs space-y-2">
               <p className="text-brand-slate"><span className="text-white">X-RateLimit-Limit:</span> 100</p>
               <p className="text-brand-slate"><span className="text-white">X-RateLimit-Remaining:</span> 42</p>
               <p className="text-brand-slate"><span className="text-white">X-RateLimit-Reset:</span> 1715421200</p>
            </div>
         </div>
      </div>
      ...
      <section className="p-8 rounded-2xl bg-brand-blue/5 border border-brand-blue/10 flex gap-6">
        ...
        <div className="space-y-2">
           <h4 className="font-bold text-white uppercase tracking-wider text-xs">Burst Allowance</h4>
           <p className="text-sm text-brand-slate leading-relaxed">
