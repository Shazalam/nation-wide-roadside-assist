    ...
    <div className="space-y-12">
      <section className="space-y-4">
        <div className="flex items-center gap-3">
           ...
           <h1 className="text-4xl font-bold text-white tracking-tight">Error Codes</h1>
        </div>
      ...
      <div className="space-y-6">
        {[
          ...
          <div key={err.code} className="flex items-start gap-6 p-6 rounded-xl border border-white/5 bg-white/5 hover:bg-white/[0.08] transition-all">
             <div className="text-2xl font-black text-brand-blue font-mono min-w-[60px]">{err.code}</div>
             <div>
                <h4 className="text-white font-bold mb-1">{err.title}</h4>
