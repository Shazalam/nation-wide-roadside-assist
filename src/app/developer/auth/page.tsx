  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <GlassPanel className="p-6 border-white/5 space-y-4">
      ...
      <section className="space-y-8">
        <div className="space-y-2">
          <h2 className="text-2xl font-bold text-white">Client Credentials Flow</h2>
...
{`{
  ...
  "scope": "fleet:read dispatch:write"
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-bold text-white">Available Scopes</h2>
      ...
      <section className="p-8 rounded-2xl bg-brand-blue/5 border border-brand-blue/10">
        <div className="flex gap-4">
          ...
          <div className="space-y-2">
            <h4 className="font-bold text-white uppercase tracking-wider text-xs">Security Best Practice</h4>
