    ...
    <div className="space-y-12">
      <section className="space-y-4">
        <div className="flex items-center gap-4">
           ...
           <div>
              <h1 className="text-4xl font-bold text-white tracking-tight">JavaScript SDK</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
         <GlassPanel className="p-6 border-white/5 flex items-center justify-between group cursor-pointer hover:bg-white/[0.02] transition-colors">
            <div className="flex items-center gap-4">
               <Package className="h-6 w-6 text-brand-blue" />
               <div>
                  <p className="text-white font-bold">npm install @nw-trans/sdk</p>
                  <p className="text-xs text-brand-slate">Latest: v4.2.0</p>
               </div>
            </div>
            <Copy className="h-4 w-4 text-brand-slate group-hover:text-white" />
         </GlassPanel>
         <GlassPanel className="p-6 border-white/5 flex items-center justify-between group cursor-pointer hover:bg-white/[0.02] transition-colors">
            <div className="flex items-center gap-4">
               <Download className="h-6 w-6 text-emerald-400" />
               <div>
                  <p className="text-white font-bold">Download Source</p>
                  <p className="text-xs text-brand-slate">ZIP / TAR.GZ</p>
               </div>
            </div>
            <Download className="h-4 w-4 text-brand-slate group-hover:text-white" />
         </GlassPanel>
      </div>
...
const client = new NWTransClient({
  ...
  timeout: 5000
      ...
      <section className="space-y-8">
        <h2 className="text-2xl font-bold text-white">Example: Requesting a Tow</h2>
    ...
    console.error('Dispatch failed:', error.message);
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
         <div className="space-y-3">
            ...
            <h4 className="text-white font-bold">Auto-Retries</h4>
         ...
         <div className="space-y-3">
            ...
            <h4 className="text-white font-bold">TypeScript First</h4>
         ...
         <div className="space-y-3">
            ...
            <h4 className="text-white font-bold">Isomorphic</h4>
      ...
      <section className="p-8 rounded-2xl bg-gradient-to-r from-brand-blue/20 to-brand-navy border border-white/10 flex flex-col md:flex-row items-center justify-between gap-6">
         <div className="space-y-2">
            <h3 className="text-xl font-bold text-white">Explore our Python and Go SDKs</h3>
            <p className="text-sm text-brand-slate">Looking for other languages? We support multiple backend environments.</p>
         </div>
         <div className="flex gap-3">
            <Button variant="outline" className="border-white/10 text-white font-mono text-xs">PYTHON</Button>
            <Button variant="outline" className="border-white/10 text-white font-mono text-xs">GOLANG</Button>
         </div>
      </section>
    </div>
  );
