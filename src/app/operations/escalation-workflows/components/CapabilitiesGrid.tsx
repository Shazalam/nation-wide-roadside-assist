...
import { Brain, ActivitySquare, UserCheck } from 'lucide-react';
import { GlassPanel } from '@/components/ui/glass-panel';

const features = [
  {
    title: "AI Incident Prioritization",
    description: "AI models analyze incident data, location, vehicle class, and risk to prioritize escalations.",
    icon: Brain,
    metric: "96.3%",
    metricLabel: "AI Accuracy"
  },
  {
    title: "SLA Recovery Intelligence",
    description: "Predictive SLA monitoring, breach detection, and automated recovery recommendations.",
    icon: ActivitySquare,
    metric: "98.9%",
    metricLabel: "SLA Recovery Rate"
  },
  {
    title: "Supervisor Intervention Systems",
    description: "Real-time supervisor alerts, escalation controls, and live intervention tools.",
    icon: UserCheck,
    metric: "97.4%",
    metricLabel: "Intervention Success"
  }
];
