...
const services = [
  ...
  { icon: CircleDashed, label: "Tire Changes" },
  { icon: Fuel, label: "Fuel Delivery" },
  { icon: Battery, label: "Battery Jumpstarts" },
  ...
  return (
    <section className="py-16 border-t border-white/5 bg-[#0A192F]/10">
      <div className="container mx-auto px-4">
        <h2 className="text-xl font-bold text-white mb-10">Escalation Support Services</h2>
