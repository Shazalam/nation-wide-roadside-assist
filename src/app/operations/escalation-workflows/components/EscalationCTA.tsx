      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        >
          <h2 className="text-3xl lg:text-4xl font-black text-white mb-6">
            Modernize Your Enterprise Escalation Infrastructure
          </h2>
          <p className="text-[15px] text-[#94A3B8] leading-relaxed mb-10">
            Connect with Nationwide Trans Inc. to automate escalation workflows, recover SLA breaches in real-time, and scale nationwide roadside operations intelligence.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button variant="outline" className="w-full sm:w-auto border-white/10 text-white hover:bg-white/5 h-12 px-8 rounded-xl font-bold bg-[#0A192F]/50 backdrop-blur-md">
              Request Escalation Audit <FileText className="ml-2 h-4 w-4 text-[#94A3B8]" />
            </Button>
          </div>
        </motion.div>
      </div>
