...
import { 
  ...
  MapPin, CheckCircle, FileText, ChevronRight
} from 'lucide-react';
...
const steps = [
  {
    ...
    description: 'Emergency roadside event logged via telematics, API, or live operator. Systems capture instant GPS data and vehicle profile.',
    icon: AlertTriangle,
  },
  {
    id: 2,
    title: 'Customer Validation',
    description: 'Instant policy and warranty validation. Automatically checks coverage limits, service eligibility, and active entitlements.',
    icon: ShieldCheck,
  },
  {
    id: 3,
    title: 'Vendor Intelligence',
    description: 'AI matches the best vendor based on SLA, location, and capacity. Auto-dispatches to certified operators with exact equipment.',
    icon: Cpu,
  },
  {
    id: 4,
    title: 'Live GPS Tracking',
    description: 'Real-time telemetry and ETA updates. Streams high-precision coordinates of the assigned tow truck directly to the customer.',
    icon: MapPin,
  },
  {
    id: 5,
    title: 'Recovery Completion',
    description: 'Vendor arrives, performs service, and confirms resolution. Digital signatures and photo evidence capture the completed job.',
    icon: CheckCircle,
  },
  {
    id: 6,
    title: 'Automated Reporting',
    description: 'Incident closed, billing automated, reports generated. Syncs structured invoice payloads directly to enterprise ledger systems.',
    icon: FileText,
  },
];
      ...
      <div className="max-w-[1536px] mx-auto px-6 lg:px-12">
        ...
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-10 lg:mb-12">
           <h2 className="text-4xl lg:text-6xl font-black text-foreground dark:text-white tracking-tighter leading-tight mb-8">
              Dispatch Operations <span className="text-[#2F80FF]">Workflow</span>
           </h2>
           <p className="text-brand-slate font-medium text-lg max-w-2xl mx-auto leading-relaxed">
             Our automated vendor mesh streamlines the entire roadside operations lifecycle, ensuring total visibility and compliance from call to clearance.
           </p>
        </div>
