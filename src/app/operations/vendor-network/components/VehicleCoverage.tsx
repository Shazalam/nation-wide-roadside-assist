...
const classes = [
  { id: 1, name: "Class 1", weight: "≤ 6,000 lbs", icon: Car, color: "text-brand-slate", bg: "bg-[#94A3B8]/10", border: "border-[#94A3B8]/30" },
  { id: 2, name: "Class 2", weight: "6,001 - 10,000 lbs", icon: Car, color: "text-brand-slate", bg: "bg-[#94A3B8]/10", border: "border-[#94A3B8]/30" },
  ...
  { id: 7, name: "Class 7", weight: "26,001 - 33,000 lbs", icon: Truck, color: "text-[#2F80FF]", bg: "bg-[#2F80FF]/10", border: "border-[#2F80FF]/30" },
  { id: 8, name: "Class 8", weight: "33,001+ lbs", icon: Truck, color: "text-[#2F80FF]", bg: "bg-[#2F80FF]/10", border: "border-[#2F80FF]/30" },
];

export const VehicleCoverage = () => {
  return (
    <GlassPanel className="p-6 border-brand-border bg-card/40 h-full">
      <h3 className="text-lg font-bold text-foreground dark:text-white mb-6">Vehicle Class Coverage</h3>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {classes.map(cls => (
          <div key={cls.id} className={`p-3 rounded-xl border ${cls.border} ${cls.bg} flex flex-col justify-between`}>
            <div>
               <div className="text-foreground dark:text-white font-bold text-sm mb-1">{cls.name}</div>
               <div className="text-[10px] text-brand-slate font-mono">{cls.weight}</div>
            </div>
