...
export const VehicleCoverage = () => {
  ...
  return (
    <section className="py-20 lg:py-24 bg-brand-bg relative overflow-hidden z-10 border-t border-brand-border">
      {/* Background Ambience */}
      ...
      <div className="container mx-auto px-6 max-w-[1536px]">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-24">
           <h2 className="text-4xl lg:text-7xl font-black text-foreground dark:text-white tracking-tighter leading-tight mb-8">
              Vehicle Class <span className="text-brand-blue">Coverage</span>
           </h2>
           <p className="text-brand-slate font-medium text-lg max-w-2xl leading-relaxed">
              Automated classification platform categorizes over 50,000 vehicle types into 8 operational weight classes for precise dispatching across the vendor network.
           </p>
        </div>
                      ...
                      >
                         <GlassPanel className="h-full p-6 border-brand-border bg-card/40 backdrop-blur-xl rounded-[2rem] flex flex-col overflow-hidden group">
                            <div className="flex justify-between items-start mb-6">
                               ...
                               <div className="h-8 w-8 rounded-lg bg-card border-brand-border flex items-center justify-center text-brand-slate">
