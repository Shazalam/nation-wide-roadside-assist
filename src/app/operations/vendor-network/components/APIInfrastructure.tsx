    ...
    <section className="py-32 bg-brand-bg/30 relative overflow-hidden border-t border-brand-border">
      ...
      <div className="container mx-auto px-4 relative z-10 max-w-[1536px]">
        ...
        <div className="max-w-4xl mb-16">
          ...
          <p className="text-brand-slate text-lg max-w-3xl">Powerful, secure, and scalable APIs that integrate vendor operations, dispatch routing, and lifecycle events directly into your systems.</p>
        </div>
