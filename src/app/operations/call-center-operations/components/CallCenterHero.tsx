        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            >
              ...
              <div className="text-[10px] font-bold text-[#94A3B8] uppercase tracking-widest mb-4">Enterprise Dispatch Communications Infrastructure</div>
            ...
            >
              ...
              <Button variant="outline" className="border-white/10 text-white hover:bg-white/5 h-11 px-6 rounded-xl font-bold bg-[#0A192F]/50 backdrop-blur-md">
                Explore Dispatch APIs <Code className="ml-2 h-4 w-4 text-[#94A3B8]" />
              </Button>
            </motion.div>
            ...
            <GlassPanel className="p-1 rounded-2xl border-white/10 bg-[#0A192F]/40 overflow-hidden relative">
               <div className="flex items-center justify-between p-4 border-b border-white/5 bg-[#081120]/60">
                  <div className="flex items-center gap-2">
                     ...
                     <span className="text-[11px] font-bold text-white uppercase tracking-widest">Live Operations Command Center</span>
                  </div>
               ...
               <div className="h-[250px] relative bg-[#081120] overflow-hidden flex items-center justify-center border-b border-white/5">
                  ...
                  <div className="absolute right-4 top-4 bg-[#0A192F]/80 p-3 rounded-lg border border-white/5">
                    <div className="text-[10px] text-[#94A3B8] font-bold uppercase tracking-wider mb-1">Active Incidents</div>
                    <div className="text-xl font-mono text-white">1,278 <span className="text-[10px] text-emerald-400">↑ 8.2%</span></div>
                  </div>
               </div>
               ...
               <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-white/5">
                  <div className="p-4 bg-[#0A192F]/80">
                     ...
                     <div className="text-[10px] text-[#94A3B8] font-bold uppercase tracking-wider mb-1">Active Calls</div>
                     <div className="text-lg font-mono text-white">1,263</div>
                  </div>
                  <div className="p-4 bg-[#0A192F]/80">
                     <Headphones className="h-4 w-4 text-[#2F80FF] mb-2" />
                     <div className="text-[10px] text-[#94A3B8] font-bold uppercase tracking-wider mb-1">Calls Handled</div>
                     <div className="text-lg font-mono text-white">8,742</div>
                  </div>
                  <div className="p-4 bg-[#0A192F]/80">
                     <Clock className="h-4 w-4 text-[#2F80FF] mb-2" />
                     <div className="text-[10px] text-[#94A3B8] font-bold uppercase tracking-wider mb-1">Avg. Handle Time</div>
                     <div className="text-lg font-mono text-white">04:28</div>
                  </div>
                  <div className="p-4 bg-[#0A192F]/80 flex flex-col justify-center items-center">
                     <div className="text-[10px] text-[#94A3B8] font-bold uppercase tracking-wider mb-2">SLA Compliance</div>
                     <div className="h-12 w-12 rounded-full border-4 border-[#2F80FF]/30 flex items-center justify-center border-t-[#2F80FF]">
                        <span className="text-xs font-bold text-white">97.8%</span>
                     </div>
                  </div>
               </div>
            </GlassPanel>
