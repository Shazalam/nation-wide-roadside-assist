      ...
      <div className="container mx-auto px-6 max-w-[1536px]">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-24">
           <h2 className="text-4xl lg:text-7xl font-black text-foreground dark:text-white tracking-tighter leading-tight mb-8">
              Vehicle Class <span className="text-[#2F80FF]">Support</span>
           </h2>
             ...
             >
                <AnimatePresence>
                   {hoveredId !== item.id ? (
                      ...
                      >
                         <GlassPanel className="h-auto w-full md:w-[105%] md:-left-[2.5%] -top-2 md:-top-4 p-4 md:p-5 border-[#2F80FF]/40 bg-card/80 backdrop-blur-[60px] rounded-[2.5rem] shadow-[0_40px_100px_rgba(0,0,0,0.7),0_0_60px_rgba(47,128,255,0.2)] flex flex-col overflow-visible pointer-events-auto z-50">
                            ...
                            <div className="relative h-24 md:h-28 w-full mb-4 flex items-center justify-center">
                               <div className="absolute inset-0 bg-[#2F80FF]/10 rounded-full blur-2xl animate-pulse" />
                               <motion.img 
                            ...
                            <div className="absolute top-[-40px] right-[-20px] text-[10rem] font-black text-[#2F80FF]/5 pointer-events-none select-none -z-10">
                               {item.id.split(' ')[1]}
                            </div>
                         </GlassPanel>
                      </motion.div>
