      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
           ...
           <div className="lg:col-span-8">
              <div className="h-full rounded-2xl border border-[#2F80FF]/20 bg-[#081120] p-1 flex flex-col relative overflow-hidden shadow-[0_0_50px_rgba(47,128,255,0.1)]">
                 <div className="absolute top-0 right-0 w-64 h-64 bg-[#2F80FF]/10 blur-3xl rounded-full" />
                 
                 <div className="flex items-center gap-2 px-4 py-3 border-b border-white/5 bg-[#0A192F]">
                    <div className="flex gap-1.5">
                       <div className="w-2.5 h-2.5 rounded-full bg-red-500/80" />
                       <div className="w-2.5 h-2.5 rounded-full bg-yellow-500/80" />
                       <div className="w-2.5 h-2.5 rounded-full bg-green-500/80" />
                    </div>
                    <span className="text-[10px] font-mono text-[#94A3B8] ml-2">POST /api/v1/dispatch/create</span>
                 </div>
                 
                 <div className="p-6 flex-1 bg-[#081120] overflow-x-auto">
...
<br/>{'}'};
<br/>
<br/><span className="text-[#94A3B8] italic">// Response:</span>
