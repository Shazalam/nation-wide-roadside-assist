...
const cards = [
  {
    title: "Nationwide Dispatch Coverage",
    desc: "Centralized orchestration across all 48 contiguous states. Extreme availability and low-latency vendor coordination.",
    type: "visibility",
    icon: Map,
  },
  {
    title: "Vendor Routing Optimization",
    desc: "Algorithmic matching of heavy-duty assets to commercial incidents based on proximity, SLA, and vehicle requirements.",
    type: "dispatch",
    icon: Network,
  },
  {
    title: "Multi-State Coordination APIs",
    desc: "Seamless programmatic handover between regional dispatch centers and integration with enterprise mobility ecosystems.",
    type: "api",
    icon: Database,
  }
] as const;
...
export const DispatchInfrastructure = () => {
  return (
    <section className="relative z-10 py-24 md:py-32 bg-brand-bg overflow-hidden border-t border-brand-border">
      {/* Background Ambience */}
        ...
        <div className="max-w-3xl mx-auto text-center mb-20">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-black text-foreground dark:text-white mb-6 tracking-tight">
              Nationwide Dispatch <span className="text-[#2F80FF]">Infrastructure</span>
            </h2>
