    ...
    <section className="py-24 bg-[#081120] relative z-10 border-t border-white/5">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                 {scenarios.map((scenario, i) => (
                   <div key={i} className="flex items-center gap-3 p-3 bg-white/[0.02] border border-white/5 rounded-lg">
                      ...
                      <div>
                         <p className="text-[10px] font-bold text-white uppercase tracking-widest">{scenario.title}</p>
                      </div>
                   </div>
                 ))}
              </div>
           ...
           <div className="lg:col-span-6 lg:order-1 h-[450px] relative rounded-3xl overflow-hidden border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
              <div className="absolute inset-0 bg-[#0A192F] opacity-90 mix-blend-multiply z-0" />
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center relative z-10 p-8">
                 ...
                 <div className="w-full max-w-sm">
                    <GlassPanel className="p-4 bg-[#081120]/90 border-red-500/30 shadow-[0_0_30px_rgba(239,68,68,0.2)]">
                       <div className="flex justify-between items-center mb-4 border-b border-white/10 pb-2">
                          ...
                          <span className="text-[9px] font-mono text-white">PRIORITY 1</span>
                       </div>
                       
                       <div className="space-y-3">
                          <div className="flex justify-between items-center">
                             <span className="text-[10px] text-[#94A3B8] font-bold uppercase tracking-wider">Asset Routing</span>
                             <span className="text-[10px] font-mono text-[#2F80FF]">OVERRIDDEN</span>
                          </div>
                          <div className="flex justify-between items-center">
                             <span className="text-[10px] text-[#94A3B8] font-bold uppercase tracking-wider">Nearest Heavy-Duty</span>
