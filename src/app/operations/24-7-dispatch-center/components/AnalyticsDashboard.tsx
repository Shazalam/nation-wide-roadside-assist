        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
           ...
           <div className="lg:col-span-5">
              <h2 className="text-3xl lg:text-4xl font-black text-foreground dark:text-white tracking-tight leading-tight mb-8">
                 ...
                 <span className="text-brand-slate">& ETA Forecasting</span>
              </h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                 {[
                   ...
                   <div key={i} className="flex items-center gap-4 bg-white/[0.02] border border-brand-border p-4 rounded-xl">
           ...
           <div className="lg:col-span-7">
              <GlassPanel className="p-6 border-brand-border bg-brand-bg relative overflow-hidden shadow-2xl">
                 <div className="absolute top-0 right-0 w-64 h-64 bg-[#2F80FF]/10 blur-3xl rounded-full" />
                 
                 <div className="flex justify-between items-center mb-8 relative z-10">
                    <div>
                       <h3 className="text-[11px] font-black text-foreground dark:text-white uppercase tracking-widest flex items-center gap-2">
                    ...
                    <div className="flex gap-4">
                       <div className="flex items-center gap-2">
                          ...
                          <span className="text-[9px] font-mono text-brand-slate">LOAD</span>
                       </div>
                       <div className="flex items-center gap-2">
                          <div className="w-2 h-2 rounded-full bg-emerald-400" />
                          <span className="text-[9px] font-mono text-brand-slate">SLA %</span>
                       </div>
                    </div>
                 </div>
