    ...
    <div className="space-y-12">
      ...
      <header className="space-y-6">
        ...
        <div className="flex gap-4">
           <button className="text-[10px] font-bold text-white uppercase tracking-widest flex items-center gap-2 px-4 py-2 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition-all">
      ...
      <section className="space-y-6">
        <h3 className="text-2xl font-bold text-white">1. Data Sovereignty</h3>
      ...
      <section className="space-y-6">
        <h3 className="text-2xl font-bold text-white">2. Asset Telemetry</h3>
        <p className="text-brand-slate leading-relaxed">
      ...
      <section className="space-y-6">
        <h3 className="text-2xl font-bold text-white">3. Third-Party Nodes</h3>
        <p className="text-brand-slate leading-relaxed">
