    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <h1 className="text-3xl font-bold text-white tracking-tight">API Infrastructure Mesh</h1>
          </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Button className="bg-brand-blue hover:bg-brand-blue/90 text-white shadow-[0_0_20px_rgba(47,128,255,0.4)]">
            Create Key
          </Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          ...
          <GlassPanel key={item.label} className="p-6 border-white/5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8">
          <GlassPanel className="p-8 h-full bg-brand-navy/60 border-white/5">
            <div className="flex items-center justify-between mb-8">
               <h3 className="text-sm font-bold text-white uppercase tracking-wider">Gateway Throughput (RPS)</h3>
        ...
        <div className="lg:col-span-4">
          <GlassPanel className="p-8 h-full bg-brand-navy/60 border-white/5 flex flex-col">
            <h3 className="text-sm font-bold text-white uppercase tracking-wider mb-8">Request Audit Log</h3>
              ...
              <AnimatePresence mode="popLayout">
                {logs.map((log) => (
                  <motion.div
                    ...
                    className="p-4 rounded-xl bg-white/[0.02] border border-white/5 hover:border-brand-blue/30 transition-all cursor-pointer group"
                  >
                    ...
                    <p className="text-xs font-mono text-white mb-2 truncate">{log.endpoint}</p>
                    <div className="flex justify-between items-center pt-2 border-t border-white/5">
                       <div className="flex items-center gap-2">
                          <div className={`h-1.5 w-1.5 rounded-full ${log.status >= 400 ? 'bg-rose-500' : 'bg-emerald-500'}`} />
                          <span className="text-[10px] font-bold text-white">Status {log.status}</span>
                       </div>
            ...
            <Button variant="ghost" className="w-full mt-6 text-brand-slate text-[10px] font-bold uppercase tracking-widest border border-white/5">
              Clear Audit Cache
            </Button>
          </GlassPanel>
        </div>
         ...
         <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex items-center gap-4">
               ...
               <div className="space-y-1">
                  <h4 className="text-lg font-bold text-white">Advanced Security Mesh</h4>
                  <p className="text-xs text-brand-slate">Real-time threat detection and rate-limiting active across all nodes.</p>
               </div>
            </div>
            <div className="flex gap-4">
               <div className="flex flex-col items-end">
                  <p className="text-[10px] font-bold text-white uppercase tracking-widest">Global Keys</p>
                  <p className="text-lg font-black text-brand-blue">1,248</p>
               </div>
               <div className="h-10 w-px bg-white/10" />
               <div className="flex flex-col items-end">
                  <p className="text-[10px] font-bold text-white uppercase tracking-widest">Active Tokens</p>
