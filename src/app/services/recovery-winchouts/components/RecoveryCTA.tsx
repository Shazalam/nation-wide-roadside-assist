...
export const RecoveryCTA = () => {
  return (
    <section className="py-44 relative z-10 bg-brand-bg overflow-hidden border-t border-white/5">
      {/* Background Ambience */}
      ...
      <div className="container mx-auto px-4 text-center">
        ...
        >
           <h2 className="text-5xl lg:text-7xl font-black text-white tracking-tight leading-tight mb-10">
              Modernize Your Recovery <br />Operations Infrastructure
           </h2>
           <p className="text-xl text-[#94A3B8] font-medium leading-relaxed mb-16 max-w-2xl mx-auto">
           ...
           <div className="flex flex-wrap justify-center gap-6">
              <Button size="lg" className="bg-[#2F80FF] hover:bg-[#2F80FF]/90 text-white font-black h-16 px-12 rounded-2xl shadow-[0_20px_40px_rgba(47,128,255,0.3)] group">
              ...
              <Button variant="outline" size="lg" className="border-white/10 text-white hover:bg-white/5 h-16 px-12 rounded-2xl font-black uppercase tracking-widest text-[11px] group">
        ...
        <div className="mt-32 relative">
           ...
           <motion.div
              ...
              className="h-[500px] w-full rounded-[3rem] overflow-hidden border border-white/10"
           >
              <img 
