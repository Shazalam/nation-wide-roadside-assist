...
const recoveryClasses = [
  { 
    ...
    category: 'Heavy Duty', 
    type: 'Bucket Trucks, Large Box , utility service fleets, and vocational vehicles.', 
  ...
  { 
    ...
    category: 'Heavy Duty', 
    type: 'School Buses, Rack Trucks, single-axle tractors, and regional delivery.',
  ...
  { 
    ...
    type: 'City Transit, Refuse, Multi-axle commercial trucks and city transit buses.', 
  ...
  { 
    ...
    category: 'Super Heavy Duty', 
    type: 'Semi-Trucks, Tractor-trailers, cement mixers, and rotator recovery.', 
                               ...
                               <div className="space-y-2">
                                  ...
                                  <div className="space-y-3 mb-2">
                                    <div className="flex justify-between items-center">
                                      ...
                                      <span className="text-xs md:text-sm font-black text-foreground dark:text-white">{item.range}</span>
                                    </div>
                                  ...
                                  <div className="bg-brand-bg/40 p-3 md:p-4 rounded-xl border border-brand-border">
                                     <div>
                                        ...
                                        <p className="text-xs md:text-sm font-black text-foreground dark:text-white leading-tight">{item.type}</p>
                                     </div>
                                  </div>
                               </div>
