  ...
  return (
    <section className="relative min-h-[90vh] lg:min-h-screen pt-24 pb-12 lg:pt-32 lg:pb-20 flex items-center overflow-hidden bg-[#020617]">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src="/assets/images/services/heavy-duty-towing-hero.png" 
          alt="Nationwide Heavy Duty Recovery Operation"
        ...
        <div className="max-w-4xl space-y-10">
          ...
          <div className="space-y-5">
            ...
            >
              ...
              <span className="text-white">Heavy-Duty Towing</span>
            </motion.div>
            ...
            >
              <div className="inline-flex items-center gap-3 px-4 py-2 rounded-xl bg-brand-blue/5 border border-brand-blue/20 backdrop-blur-md">
                ...
                <span className="text-[9px] font-black text-white uppercase tracking-[0.25em]">Tier-1 Commercial Recovery Network</span>
              </div>
            </motion.div>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              Enterprise <span className="text-brand-blue">Heavy-Duty</span> <br />
