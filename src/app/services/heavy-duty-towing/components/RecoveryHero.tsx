        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5 space-y-10">
            ...
            >
              ...
              <span className="text-white/60">Heavy-Duty Towing</span>
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-6xl lg:text-[6.5rem] font-black leading-[1] tracking-tight"
            >
              Enterprise <br />
              ...
              <br />
              <span className="text-white italic font-medium opacity-90">Recovery</span>
            </motion.h1>
            ...
            >
              {[
                ...
                { label: 'Fleet Network', val: 'Nationwide', icon: Globe, color: 'text-purple-400' },
            ...
            >
              <GlassPanel className="p-0 border-white/10 bg-[#0A192F]/90 shadow-[0_50px_100px_rgba(0,0,0,0.8)] overflow-hidden">
                   ...
                   <div className="flex items-center gap-5">
                      <div className="flex flex-col">
                         ...
                         <div className="flex items-center gap-2 mt-1">
                            ...
                            <span className="text-[9px] font-bold text-emerald-400 uppercase tracking-widest">Global Command Active</span>
                         </div>
                      </div>
                   </div>
                   <div className="flex items-center gap-3">
                      <div className="px-4 py-1.5 bg-white/5 border border-white/10 rounded-xl text-[10px] font-bold text-[#94A3B8] uppercase tracking-widest">
                         All Regions
                      </div>
                   </div>
                </div>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-12 h-[650px]">
                   {/* Stats Sidebar */}
                   <div className="xl:col-span-4 border-r border-white/5 p-8 space-y-8">
                      {[
                   ...
                   <div className="xl:col-span-8 relative bg-[#081120]/50 overflow-hidden">
                      {/* Simulated Map */}
                      <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'linear-gradient(#2F80FF1A 1px, transparent 1px), linear-gradient(90deg, #2F80FF1A 1px, transparent 1px)', backgroundSize: '40px 40px' }} />
                      ...
                      <div className="absolute top-10 right-10 z-20">
                         <GlassPanel className="p-5 bg-brand-navy/95 border-brand-blue/30 w-64 shadow-2xl">
                            <div className="flex justify-between items-center mb-5">
                               ...
                               <span className="text-[10px] font-mono text-[#94A3B8]">ETA 18 min</span>
                            </div>
                            <h3 className="text-xl font-black text-white mb-5 leading-tight">INC-7849 <br /><span className="text-sm font-medium text-[#94A3B8]">Semi Truck Recovery</span></h3>
                            <div className="space-y-4 mb-6">
                               <div className="flex justify-between text-[10px]">
                                  <span className="text-[#94A3B8] font-bold uppercase tracking-widest">Location</span>
                                  <span className="text-white font-black">I-70, Colorado</span>
                               </div>
                               <div className="flex justify-between text-[10px]">
                                  <span className="text-[#94A3B8] font-bold uppercase tracking-widest">Operator</span>
                                  <span className="text-white font-black">Heavy Haul Inc.</span>
                               </div>
                            </div>
                            <Button className="w-full bg-brand-blue hover:bg-brand-blue/90 text-white font-bold h-10 text-[10px] uppercase tracking-widest">Track Operator</Button>
                         </GlassPanel>
                      </div>
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-10 grid grid-cols-3 gap-10 bg-gradient-to-t from-brand-bg to-transparent">
                         {[
                           ...
                           <div key={i} className="space-y-3">
                              <p className="text-[10px] font-bold text-[#94A3B8] uppercase tracking-widest">{m.label}</p>
                              <div className="flex items-end gap-3">
                                 <span className="text-2xl font-black text-white">{m.val}</span>
                                 <span className="text-[10px] font-bold text-emerald-400 pb-1">{m.trend}</span>
                              </div>
              ...
              <motion.div
                ...
                className="absolute -right-12 bottom-1/4 z-30"
              >
                 <GlassPanel className="p-8 border-white/10 bg-[#0A192F]/90 shadow-2xl w-64">
                    <div className="flex justify-between items-center mb-8">
                       <p className="text-[11px] font-black text-white uppercase tracking-widest">Requests Hub</p>
                       <Badge variant="outline" className="text-[9px] border-white/10 text-[#94A3B8]">Total 3.2M</Badge>
                    </div>
                    ...
                    <div className="flex items-center justify-center h-32 relative">
                       ...
                       <div className="absolute inset-0 flex flex-col justify-between py-2 text-[9px] font-bold">
                          ...
                          <div className="flex justify-between">
                             <span className="text-purple-400">Road Service 15%</span>
                             <span className="text-emerald-400">Fuel 10%</span>
                          </div>
                       </div>
                    </div>
                    ...
                    <div className="mt-8 space-y-3">
                       {[
                         ...
                         { l: 'Road Service', v: 15, c: 'bg-purple-400' }
                       ].map((r, i) => (
                         <div key={i} className="flex items-center gap-3">
                            <div className={`h-1.5 w-1.5 rounded-full ${r.c}`} />
                            <span className="text-[10px] font-bold text-[#94A3B8] flex-1">{r.l}</span>
                            <span className="text-[10px] font-black text-white">{r.v}%</span>
                         </div>
                       ))}
                    </div>
                 </GlassPanel>
