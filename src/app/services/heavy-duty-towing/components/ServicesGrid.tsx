...
import { 
  Truck, Navigation, Anchor, Shield, 
  Container, CircleDot, Activity, Wrench, 
  Zap, Lock, Globe, Settings
} from 'lucide-react';
...
const services = [
  ...
  { 
    ...
    desc: 'Specialized support for heavy tractors, trailers, and cargo in mission-critical scenarios.',
    icon: Container,
  ...
  { 
    ...
    desc: 'Specialized 4x4 recovery for vehicles in off-road, deep mud, or remote wilderness recovery sites.',
    icon: Navigation,
    image: 'https://images.unsplash.com/photo-1571408899849-c454eef71465?auto=format&fit=crop&q=80'
  }
];
        ...
        <div className="max-w-3xl mx-auto text-center mb-24">
          ...
          >
            <h2 className="text-4xl lg:text-6xl font-black text-foreground dark:text-white tracking-tighter leading-tight mb-8">
               Recovery <span className="text-[#2F80FF]">Solutions</span>
            </h2>
