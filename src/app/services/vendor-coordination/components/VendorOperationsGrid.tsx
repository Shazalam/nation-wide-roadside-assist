             ...
             >
                <GlassPanel className="h-full p-10 border-white/5 bg-white/[0.01] hover:bg-white/[0.03] transition-all group overflow-hidden relative flex flex-col justify-between">
                   ...
                   <div className="h-40 w-full mb-10 relative opacity-60 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                     ...
                     {i === 0 && (
                       <div className="w-full h-full border border-white/5 rounded-xl bg-[url('https://images.unsplash.com/photo-1556388158-158ea5ccacbd?auto=format&fit=crop&q=80')] bg-cover bg-center mix-blend-luminosity" />
                     )}
                     {i === 1 && (
                     ...
                     {i === 2 && (
                       <div className="w-full h-full border border-white/5 rounded-xl bg-[#0A192F] bg-opacity-50 border-brand-blue/20" style={{ backgroundImage: 'radial-gradient(circle at center, #2F80FF22 1px, transparent 1px)', backgroundSize: '16px 16px' }} />
                     )}
