...
const solutions = [
  {
    ...
    desc: 'Integrate nationwide vendor management directly into your mobility stack. Coordinate and dispatch towing, roadside repair, and commercial recovery events programmatically.',
    prompt: 'Vendor Features',
    features: [
      'Standardized CRUD endpoints',
      'Automated dispatch handoffs',
      'Service verification systems',
      'Live coordinator workflows',
      'Billing invoice generators',
      'Direct partner notifications'
    ],
    cards: [
      {
        title: 'Vendor Dispatch',
        desc: 'Specialized routing algorithms matching vehicles with certified local towing vendors.',
        glow: 'rgba(59,130,246,0.15)'
      },
      {
        title: 'Location Match',
        desc: 'Identifies nearest heavy rotators and light-duty repair squads automatically.',
        glow: 'rgba(6,182,212,0.15)'
      },
      {
        title: 'SLA Priority',
        desc: 'Keeps dispatch responses synchronized with strict contract commitments.',
        glow: 'rgba(139,92,246,0.15)'
      },
      {
        title: 'Depot Routing',
        desc: 'Enables quick routing coordinates handoffs to authorized fleet hubs.',
  ...
  },
  {
    ...
    label: 'Telemetry API',
    icon: Eye,
    title: 'Live Telemetry & Tracking Stream',
    desc: 'Monitor recovery unit coordinates, dispatcher updates, and vehicle sensors dynamically via streaming telemetry sockets.',
    prompt: 'Telemetry Streams',
    features: [
      'Live coordinates stream',
      'Continuous telemetry alerts',
      'WebSocket event handlers',
      'ETA adjustment calculation',
      'Drift warning alarms',
      'Custom incident updates'
    ],
    cards: [
      {
        title: 'GPS Tracking',
        desc: 'High-precision coordinate feeds map vehicle paths continuously.',
        glow: 'rgba(245,158,11,0.15)'
      },
      {
        title: 'Auto-Alerts',
        desc: 'Triggers dispatch orders automatically on engine error warnings.',
        glow: 'rgba(6,182,212,0.15)'
      },
      {
        title: 'Diagnostics Node',
        desc: 'Monitors fuel indicators, battery levels, and critical fault codes.',
        glow: 'rgba(59,130,246,0.15)'
      },
      {
        title: 'Cloud Scaling',
        desc: 'High-concurrency data handlers designed for enterprise-scale traffic.',
        glow: 'rgba(139,92,246,0.15)'
      }
    ]
  },
  {
    ...
    desc: 'Receive instant pushes when dispatches are resolved, bills are generated, or vendor status changes.',
    ...
    features: [
      ...
      'Modular event routing',
      'Retry failover buffer'
    ],
    cards: [
      {
        title: 'Immediate Push',
        desc: 'Streams updates immediately to your membership dashboard endpoints.',
        glow: 'rgba(16,185,129,0.15)'
      },
      {
        title: 'Invoicing Payloads',
        desc: 'Generates structured invoice details for direct ledger entry.',
        glow: 'rgba(59,130,246,0.15)'
      },
      {
        title: 'HMAC Security',
        desc: 'Authenticates callback requests with secure payload signatures.',
        glow: 'rgba(139,92,246,0.15)'
      },
      {
        title: 'Failover Buffers',
        desc: 'Stores messages automatically if subscriber servers disconnect.',
        glow: 'rgba(236,72,153,0.15)'
      }
    ]
  }
    ...
    <section className="py-32 bg-brand-bg/30 relative overflow-hidden border-t border-brand-border">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-4xl mb-16">
          ...
          <p className="text-brand-slate text-lg max-w-3xl">Power your systems with our robust APIs and real-time operational feeds.</p>
        </div>
