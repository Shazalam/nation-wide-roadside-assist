...
import { Shield, Zap, Globe, Clock, ArrowRight, Activity, ChevronRight } from 'lucide-react';
  ...
  return (
    <section className="relative min-h-[90vh] lg:min-h-screen pt-24 pb-12 lg:pt-32 lg:pb-20 flex items-center overflow-hidden bg-[#020617]">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src="/assets/images/services/vendor-coordination-hero.png" 
          alt="Nationwide Live Network Overview Map Operations"
        ...
        <div className="max-w-4xl space-y-10">
          ...
          <div className="space-y-5">
            ...
            >
              ...
              <span className="text-white">Vendor Coordination</span>
            </motion.div>
            ...
            >
              <div className="inline-flex items-center gap-3 px-4 py-2 rounded-xl bg-brand-blue/5 border border-brand-blue/20 backdrop-blur-md">
                ...
                <span className="text-[9px] font-black text-white uppercase tracking-[0.25em]">Tier-1 Commercial Dispatch Network</span>
              </div>
            </motion.div>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              Enterprise Vendor <span className="text-brand-blue">Coordination &</span> <br />
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 pt-12">
            {[
              { label: 'SLA Compliance', val: '98.9%', icon: Shield, color: 'text-brand-blue' },
              { label: 'Dispatch Events', val: '2.7M+', icon: Activity, color: 'text-brand-orange' },
      ...
      <div className="absolute bottom-12 right-12 z-20 hidden xl:block">
         <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3 px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/20 backdrop-blur-md">
               ...
               <span className="text-[9px] font-black text-emerald-400 uppercase tracking-widest leading-none">Command Active</span>
            </div>
         </div>
      </div>
    </section>
