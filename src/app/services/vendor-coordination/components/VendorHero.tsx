...
import { Shield, Zap, Globe, Clock, ArrowRight, Activity, ChevronRight, FileText } from 'lucide-react';
  ...
  return (
    <section className="relative min-h-[90vh] lg:min-h-screen pt-20 pb-8 lg:pt-28 lg:pb-12 flex items-center overflow-hidden bg-[#020617]">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src="/images/vendor-coordination-hero.jpg" 
          alt="Enterprise Vendor Coordination Operations"
