...
export const ContinuationCTA = () => {
  return (
    <section className="py-44 relative z-10 bg-[#081120] overflow-hidden border-t border-white/5">
      {/* Background Ambience */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
           <div className="lg:col-span-7">
             ...
             >
                ...
                <p className="text-lg text-[#94A3B8] font-medium leading-relaxed mb-12 max-w-xl">
                ...
                <div className="flex flex-wrap gap-4">
                   <Button size="lg" suppressHydrationWarning className="bg-[#2F80FF] hover:bg-[#2F80FF]/90 text-white font-bold h-14 px-8 rounded-xl shadow-[0_20px_40px_rgba(47,128,255,0.3)] group">
                      Contact Enterprise Team <ArrowRight className="ml-3 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                   </Button>
                   <Button variant="outline" size="lg" suppressHydrationWarning className="border-white/10 text-white hover:bg-white/5 h-14 px-8 rounded-xl font-bold uppercase tracking-widest text-[11px] group">
           ...
           <div className="lg:col-span-5 hidden lg:flex justify-end">
              <motion.div
                 ...
                 className="h-[400px] w-full max-w-md rounded-3xl overflow-hidden border border-white/10 relative"
              >
