...
export const TrustSection = () => {
  return (
    <section className="py-24 relative z-10 border-y border-brand-border bg-brand-bg/50">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          
          {/* Partners Marquee Area */}
          <div className="lg:col-span-7">
             <p className="text-[10px] font-black text-brand-slate uppercase tracking-[0.4em] mb-12">Trusted by Industry Leaders</p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-8">
                   {badges.map((b, i) => (
                     <div key={i} className="flex flex-col items-center text-center gap-3 group">
                        ...
                        <span className="text-[9px] font-bold text-brand-slate uppercase tracking-widest leading-tight">{b.label}</span>
                     </div>
                   ))}
                </div>
             </GlassPanel>
