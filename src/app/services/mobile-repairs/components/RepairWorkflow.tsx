...
const steps = [
  { 
    ...
    desc: 'Customer or fleet system submits a request via API or secure enterprise portal.', 
    icon: FilePlus,
  ...
  { 
    ...
    desc: 'Issue is identified, categorized, and mechanical severity is assessed remotely.', 
    icon: Activity,
  ...
  { 
    ...
    desc: 'Best-fit certified mobile technician is selected by our intelligent dispatch engine.', 
    icon: UserCheck,
  ...
  { 
    ...
    desc: 'AI finds the fastest and most efficient route to the breakdown location.', 
    icon: Route,
  ...
  { 
    ...
    desc: 'Real-time GPS telemetry and dynamic ETA updates for all stakeholders.', 
    icon: MapPin,
  ...
  { 
    ...
    desc: 'Technician arrives with full equipment and completes the mechanical resolution.', 
    icon: Wrench,
  ...
  { 
    ...
    desc: 'Automated reporting, photos, and digital billing processed instantly.', 
    icon: FileText,
      ...
      <div className="max-w-[1536px] mx-auto px-6 lg:px-12">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-32">
           ...
           <h2 className="text-4xl lg:text-6xl font-black text-foreground dark:text-white tracking-tighter leading-tight mb-8">
              Our Mobile Repair <span className="text-[#2F80FF]">Workflow</span>
           </h2>
           <p className="text-brand-slate font-medium text-lg max-w-2xl mx-auto leading-relaxed">
             A high-performance orchestration layer designed for rapid, on-site mechanical resolution across your entire fleet.
           </p>
        </div>
        ...
        <div className="mt-32 border-t border-brand-border pt-16 flex flex-wrap justify-center gap-16">
           {[
             { label: 'Network Latency', val: '< 0.8s', detail: 'Real-Time' },
             { label: 'Dispatch Accuracy', val: '99.9%', detail: 'Optimized' },
             { label: 'Repair Success', val: '98.4%', detail: 'Enterprise' },
             { label: 'Automation Status', val: 'Live', detail: 'Mesh' }
           ].map((m, i) => (
