    ...
    <section className="py-12 lg:py-16 bg-brand-bg relative overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 lg:mb-10">
          ...
          >
             Assistance <span className="text-[#2F80FF]">Capabilities</span>
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Access our robust infrastructure ensuring reliable, fast, and seamless roadside assistance operations across the country.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          ...
          {/* Card 1: Nationwide Assistance Network */}
          <motion.div
            ...
            <div className="flex-1 flex flex-col w-full h-full relative z-10 justify-center">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#2F80FF]/20 to-transparent border border-[#2F80FF]/30 flex items-center justify-center shrink-0">
                  <Globe className="w-5 h-5 text-[#2F80FF]" />
                </div>
              ...
              <p className="text-[13px] text-brand-slate leading-relaxed">
                Access a vetted network of professional providers across the country, ensuring fast response times.
              </p>
            </div>
          ...
          >
            ...
            <div className="flex-1 flex flex-col w-full h-full relative z-10 justify-center">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-bold text-foreground dark:text-white leading-snug">
                  SLA-Driven<br/>Dispatch
                </h3>
              </div>
              <p className="text-[13px] text-brand-slate leading-relaxed">
                AI-powered dispatching, real-time routing, and SLA monitoring ensure every customer gets the right help at the right time.
              </p>
            </div>
          ...
          {/* Card 3: API-First Infrastructure */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <div className="flex-1 flex flex-col w-full h-full relative z-10 justify-center">
              ...
              <p className="text-[13px] text-brand-slate leading-relaxed">
                Seamlessly integrate roadside assistance into your platforms with our robust APIs and webhooks.
              </p>
            </div>
