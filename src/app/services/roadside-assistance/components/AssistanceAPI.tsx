...
const solutions = [
  {
    ...
    desc: 'Automate roadside assistance request dispatching. Instantly match requests to nearest service providers, verify policy coverage, and issue digital service orders.',
    prompt: 'Dispatch Capabilities',
    features: [
      'Instant service dispatch routing',
      'Automatic coverage verification',
      'Intelligent vendor dispatch mesh',
      'Live priority incident tagging',
      'Programmatic service creation',
      'Digital service order logging'
    ],
    cards: [
      {
        title: 'Smart Matching',
        desc: 'Identifies and requests the optimal provider based on real-time location and equipment.',
        glow: 'rgba(59,130,246,0.15)'
      },
      {
        title: 'Auto Coverage',
        desc: 'Validates driver benefits and policy coverage levels programmatically on request.',
        glow: 'rgba(6,182,212,0.15)'
      },
      {
        title: 'JSON Payload',
        desc: 'Clean REST endpoints for integrating roadside triggers into custom systems.',
        glow: 'rgba(139,92,246,0.15)'
      },
      {
        title: 'SLA Guard',
        desc: 'Ensures dispatches align with internal response time and distance thresholds.',
  ...
  },
  {
    ...
    icon: Eye,
    title: 'Dynamic Telemetry & Status Sync',
    desc: 'Remove user uncertainty with active tracking. Streams high-precision GPS coordinates, routes updates, and manages ETA calculations dynamically.',
    prompt: 'Tracking Capabilities',
    features: [
      'Live GPS coordinate feeds',
      'Dynamic ETA calculations',
      'Technician status alerts',
      'Map route mapping streams',
      'Automated status updates',
      'Provider vehicle telemetry'
    ],
    cards: [
      {
        title: 'GPS Tracking',
        desc: 'Streams active provider vehicle positions directly to member tracking views.',
        glow: 'rgba(245,158,11,0.15)'
      },
      {
        title: 'Dynamic ETA',
        desc: 'Recalculates travel times dynamically based on traffic conditions and route logs.',
        glow: 'rgba(6,182,212,0.15)'
      },
      {
        title: 'Status Engine',
        desc: 'Tracks step-by-step milestones: dispatched, en-route, arrived, completed.',
        glow: 'rgba(59,130,246,0.15)'
      },
      {
        title: 'Telemetry Broker',
        desc: 'Ingests active data streams from multiple vendor network providers.',
        glow: 'rgba(139,92,246,0.15)'
      }
    ]
  },
  {
    ...
    prompt: 'Webhook Capabilities',
    features: [
      'dispatch.created callbacks',
      'technician.arrived alerts',
      'service.completed webhooks',
      'HMAC payload signature check',
      'Automatic retry failover',
      'Billing & metadata payloads'
    ],
    cards: [
      {
      ...
      },
      {
        ...
        desc: 'Ensures callback authenticity with HMAC signature header checks.',
        glow: 'rgba(59,130,246,0.15)'
      },
      {
        title: 'Auto Claims',
        desc: 'Launches automated claims processes immediately upon service completion.',
        glow: 'rgba(139,92,246,0.15)'
      },
      {
        title: 'Payload Custom',
        desc: 'Passes arbitrary reference tags and tracking numbers across events.',
        glow: 'rgba(236,72,153,0.15)'
      }
    ]
  }
    ...
    <section className="py-32 bg-brand-bg/30 relative overflow-hidden border-t border-brand-border">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-4xl mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-6">API-First <span className="text-brand-blue">Assistance Infrastructure.</span></h2>
          <p className="text-brand-slate text-lg max-w-3xl">Seamlessly integrate roadside operations into your existing platforms with our robust developer tools, real-time webhooks, and enterprise SDKs.</p>
        </div>
