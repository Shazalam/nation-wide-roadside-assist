...
import {
  Shield, Zap, Globe, Clock, ChevronRight, Activity
} from 'lucide-react';
  ...
  return (
    <section className="relative min-h-[90vh] lg:min-h-screen pt-20 pb-8 lg:pt-28 lg:pb-12 flex items-center overflow-hidden bg-[#020617]">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="/assets/images/services/roadside-assistance-hero.png"
          alt="Enterprise Roadside Assistance Operations"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <div className="max-w-4xl space-y-10">
          ...
          <div className="space-y-4">
            ...
            >
              Enterprise <span className="text-brand-blue">Roadside</span> <br />
            ...
            >
              Nationwide roadside dispatch coordination, enterprise-grade support operations, 
              and API-first assistance infrastructure engineered for insurers, fleets, OEMs, 
