  ...
  return (
    <section className="relative min-h-[90vh] lg:min-h-screen pt-20 pb-8 lg:pt-28 lg:pb-12 flex items-center overflow-hidden bg-[#020617]">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="/fleet_rental_hero.jpg"
          alt="Enterprise Fleet & Rental Roadside Operations"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <div className="max-w-4xl space-y-10">
          ...
          <div className="space-y-5">
            ...
            >
              <span className="hover:text-white transition-colors cursor-pointer" onClick={() => router.push('/')}>Solutions</span>
              <ChevronRight className="h-3 w-3 text-brand-blue" />
              <span className="text-white">Fleet & Rental Operations</span>
            </motion.div>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              Enterprise <span className="text-brand-blue">Fleet</span> <br />
              & Rental Operations
            </motion.h1>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 pt-12">
            {[
              { label: 'Fleet Response Efficiency',  val: '99.2%',      icon: Shield,   color: 'text-brand-blue'   },
              { label: 'Fleet Dispatch Events', val: '4.8M+',      icon: Zap,      color: 'text-brand-orange' },
              { label: 'Vendor Coverage', val: 'Nationwide',  icon: Globe,    color: 'text-purple-400'   },
              { label: 'Operations Intelligence',  val: '24/7',        icon: Clock,    color: 'text-emerald-400'  },
            ].map((m, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
