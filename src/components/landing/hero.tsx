  ...
  return (
    <section className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-40">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full -z-10 overflow-hidden">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-brand-orange/5 blur-[120px] rounded-full opacity-50 dark:opacity-100" />
      </div>
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <Button size="lg" className="bg-brand-blue hover:bg-brand-blue/90 text-foreground dark:text-white px-8 h-12 text-base font-semibold shadow-[0_0_25px_var(--brand-glow)] group">
              Start Building 
              <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
            </Button>
            <Button size="lg" variant="outline" className="border-brand-border bg-foreground/[0.03] hover:bg-foreground/[0.06] text-foreground px-8 h-12 text-base font-semibold">
              View API Docs
            </Button>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-32 max-w-6xl mx-auto">
          {[
            ...
            <motion.div
              ...
              className="p-8 rounded-2xl border border-brand-border bg-card/50 backdrop-blur-sm hover:border-brand-blue/50 transition-colors group shadow-sm dark:shadow-none"
            >
