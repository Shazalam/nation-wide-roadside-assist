                ...
                >
                  ...
                  <div className="flex items-start gap-6 relative z-10">
                    <div className={`h-12 w-12 rounded-xl flex items-center justify-center border transition-all ${
                      activeTab === tab.id 
                        ? `bg-${tab.color}/10 border-${tab.color}/30 text-${tab.color}` 
                        : 'bg-white/5 border-white/5 text-brand-slate'
                    }`}>
          ...
          <div className="lg:col-span-7 relative h-[600px] flex items-center justify-center">
            <div className="relative w-full h-full perspective-[2000px]">
              ...
              <motion.div
                ...
                className="absolute inset-0 bg-[#0A192F] rounded-[3rem] border border-white/10 shadow-2xl overflow-hidden"
              >
                <div className="absolute inset-0 opacity-20" style={{ backgroundImage: 'radial-gradient(circle, #2F80FF 1px, transparent 1px)', backgroundSize: '30px 30px' }} />
                
                {/* Animated Map Points */}
                <div className="absolute top-[40%] left-[30%] h-3 w-3 bg-brand-blue rounded-full shadow-[0_0_15px_#2F80FF] animate-pulse" />
                <div className="absolute top-[60%] left-[50%] h-3 w-3 bg-brand-blue rounded-full shadow-[0_0_15px_#2F80FF] animate-pulse delay-700" />
                ...
                <div className="absolute bottom-12 left-12">
                   <div className="flex items-center gap-2 mb-2">
                     ...
                     <span className="text-[10px] font-bold text-white uppercase tracking-widest">Live Node Visibility</span>
                   </div>
              ...
              >
                <GlassPanel className="p-6 bg-brand-navy/90 border-brand-blue/30 shadow-[0_30px_60px_rgba(0,0,0,0.5)]">
              ...
              >
                <GlassPanel className="p-6 bg-brand-navy/90 border-white/10 shadow-[0_30px_60px_rgba(0,0,0,0.5)]">
                  <div className="flex items-center gap-3 mb-6">
                    <Navigation className="h-5 w-5 text-emerald-500" />
                    <span className="text-[10px] font-bold text-white uppercase tracking-widest">Asset FLT-0092</span>
                  </div>
                  <div className="space-y-4">
              ...
              <AnimatePresence>
                {activeTab === 'dispatch' && (
                  ...
                  >
                    <GlassPanel className="p-6 border-emerald-500/30 bg-brand-navy/95 shadow-[0_0_50px_rgba(16,185,129,0.2)]">
                      <div className="flex items-center gap-2 mb-4">
                        <Zap className="h-4 w-4 text-emerald-500" />
                        <span className="text-[10px] font-bold text-white uppercase tracking-widest">AI ROUTE OPTIMIZED</span>
                      </div>
